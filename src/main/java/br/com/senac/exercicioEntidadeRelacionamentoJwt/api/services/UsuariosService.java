...
import br.com.senac.exercicioEntidadeRelacionamentoJwt.api.dtos.UsuariosRequestDTO;
import br.com.senac.exercicioEntidadeRelacionamentoJwt.api.dtos.UsuariosResponseDTO;
import br.com.senac.exercicioEntidadeRelacionamentoJwt.api.entidades.Usuarios;
import br.com.senac.exercicioEntidadeRelacionamentoJwt.api.jwt.TokenService;
import br.com.senac.exercicioEntidadeRelacionamentoJwt.api.repositorios.UsuariosRepositorio;
...
public class UsuariosService {
    ...
    public UsuariosResponseDTO cadastrarUsuario(UsuariosRequestDTO usuario) {
        ...
        retorno.setId(usuarioFinal.getId());
    ...
    public UsuariosResponseDTO loginUsuario(UsuariosRequestDTO usuario) {
        ...
        if(passwordEncoder.matches(usuario.getSenha(), usuarioLogin.getSenha())) {
            ...
            response.setId(usuarioLogin.getId());
